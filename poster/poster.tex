...
\begin{itemize}
  ...
  \item \col{Gaussian Processes} have a elegant mechanism for incorporating prior beliefs about functions - the mean and covariance functions.
\end{itemize}
\vspace{1cm}
...
W $ \bm \phi ^* =  \amin{\bm \phi}   \E _{\X \sim p(\X)}  \kl [\pbnn (\bm f(\X) |  \bm \phi ) | \pgp (\bm f(\X )  ] $
\begin{eqnarray*}
...
\mysection{Estimating Entropy of BNN Priors}{
...
\mysection{Prior Results}{
\setlength{\tabcolsep}{-0.25cm}
\begin{tabular}{ccc}
\small \textcolor{Green}{Gaussian Process Prior}  &
\small \textcolor{Red}{GP-BNN Prior} &
\small \textcolor{Blue}{Standard BNN Prior} \\ \normalsize
{\includegraphics[width = 3.6in]{figures/priors/zogpp}} &
{\includegraphics[width = 3.6in]{figures/priors/zogppbnn}} &
{\includegraphics[width = 3.6in]{figures/priors/zobnn}} \\ % TOO SMALL ??
\end{tabular}
...
\mysection{Posterior Results }{

We test our model (blue) on 2 different toy problems. 
All BNNs are 2 layer with rbf activation functions. GPs use RBF kernels. 
